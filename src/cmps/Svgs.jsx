export const Svgs = {
  logo: (
    ...
    >
      <title>Spotify</title>
      <path
        d="M13.427.01C6.805-.253 1.224 4.902.961 11.524.698 18.147 5.853 23.728 12.476 23.99c6.622.263 12.203-4.892 12.466-11.514S20.049.272 13.427.01m5.066 17.579a.717.717 0 0 1-.977.268 14.4 14.4 0 0 0-5.138-1.747 14.4 14.4 0 0 0-5.42.263.717.717 0 0 1-.338-1.392c1.95-.474 3.955-.571 5.958-.29 2.003.282 3.903.928 5.647 1.92a.717.717 0 0 1 .268.978"
  ...
  collapseIcon: (
    <svg
      ...
      role="img"
      aria-hidden="true"
      className="e-91000-icon e-91000-baseline e-91000-icon--auto-mirror"
      viewBox="0 0 16 16"
      fill="currentColor"
      style={{
  ...
  expandIcon: (
    ...
    >
      <path d="M6.53 9.47a.75.75 0 0 1 0 1.06l-2.72 2.72h1.018a.75.75 0 0 1 0 1.5H1.25v-3.579a.75.75 0 0 1 1.5 0v1.018l2.72-2.72a.75.75 0 0 1 1.06 0z" />
      <path d="M9.47 6.53a.75.75 0 0 1 0-1.06l2.72-2.72h-1.018a.75.75 0 1 1 0-1.5h3.578v3.579a.75.75 0 0 1-1.5 0V3.81l-2.72 2.72a.75.75 0 0 1-1.06 0z" />
    </svg>
  ),
  editIcon: (
    <svg
      ...
      fill="currentColor"
      style={{
        "--encore-icon-height": "var(--encore-graphic-size-decorative-larger-3)",
        "--encore-icon-width": "var(--encore-graphic-size-decorative-larger-3)",
      }}
    >
