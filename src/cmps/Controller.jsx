    ...
    return (
        <div className="media-controller">
            ...
            <div className="media-controls">
                ...
                >
                    {isPlaying ? (
                        <img src="/src/assets/spotify-icons/now-playing.svg" alt="Pause" />
                    ) : (
            ...
            <div className="right-controls">
                ...
                <button className="control-btn microphone" title="Microphone">
                    <img src="/src/assets/spotify-icons/notification.svg" alt="Microphone" />
                </button>
                ...
                <div className="volume-control">
                    ...
                    >
                        <img 
                            src={isMuted ? "/src/assets/spotify-icons/mute.svg" : "/src/assets/spotify-icons/notification.svg"} 
                            alt="Volume" 
                        />
                    </button>
